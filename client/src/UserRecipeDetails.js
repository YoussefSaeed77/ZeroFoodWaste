...
const UserRecipeDetails = () => {
    ...
    useEffect(() => {if (recipe && currentUser && currentUser._id !== recipe.userId) {
        if (isAuthenticated) {
            fetch(`/add-to-viewed`, {
                method: "PATCH",
                headers: {
        ...
        <Wrapper>
            {
                ...
                <RecipeInfo>
                    ...
                    <Div1>
                        <Div2>
                            ...
                            <p>Total cooking time: <Detail>{recipe.readyInMinutes}</Detail></p>
                            <LikeDiv>
                    </LikeDiv>
                        </Div2>
                    ...
                    <Instructions>
                        {
                            recipe.instructions.map((step) => {
                                return(<Line>
                                    <p>Equipment required: <Detail>{step.equipment}</Detail>
                                    </p>
                ...
                <div>
                    {
                        recipe && currentUser && currentUser._id === recipe.userId?
                        <p></p>
                        :
                        <div>
